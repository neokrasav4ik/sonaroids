...
- **Что хранится:** счёт, уровень, длительность, время, номер раскладки и запись высоты ладони (несколько КБ на партию), ник. Игрок — случайный ключ с телефона, в базе только его хеш. Адреса не хранятся (ограничение частоты — только в памяти).
