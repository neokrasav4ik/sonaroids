...
- `tools/` — инструменты разбора и проверки; все берут код из собранного приложения:
  ...
  - `tests/` — стенды страницы: подготовка без калибровки, центровка, подстройка по взмахам, игра, журнал партии, журнал настройки, пропажа зонда, автоуровень, запуск микрофона;
