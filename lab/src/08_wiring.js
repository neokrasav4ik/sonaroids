...
function goFlow(flow){ if(flow==='rec'||flow==='recLong'){ lastRec=flow; runRec(flow==='recLong'); } else quickStart(); }
var lastRec='rec';
...
el('recAgain').addEventListener('click',function(){ viaOrient(lastRec); });
