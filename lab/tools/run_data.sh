...
# журналы партий — game_log.py и replay_game.js; длинные записи по метке (sonarlong_*) — eval_long.js; записи вбок (sonarside_*, телефон вертикально) — eval_side.js; «два динамика» (sonardual_*) — eval_dual.js. Журналы и лабы (sonar_*), и самой игры (sonaroids_*).
