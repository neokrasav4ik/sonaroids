...
PSETUP={
 ...
 'rightPlayFlip':"lastRec='recRight'; document.body.classList.add('flip'); show('rightPlay'); rpText('Переверни телефон','Разъём наверху, от себя. Ладонь — справа от верхнего торца.'); rpButtons(true); rpDraw();",
