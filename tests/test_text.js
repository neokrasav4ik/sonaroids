...
const BUTTONS=['play','recal','howto','lang','sfx_on','sfx_off','next','allow','start','again','menu','logs','retry','resume','quit','exit','restart','rs_go','back','scores','p_day','p_week','p_all','name_set','done','later','link','link_show','link_in'];
